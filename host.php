...
<div class="container">
    ...
    <div class="hidden" id="body-prebattle">
        <button class="btn btn-danger btn-lg" data-toggle="modal" data-target="#modalNewBattle">New Battle</button>
    </div>
...
<!-- Modal dialog for starting battles -->
<div class="modal fade" id="modalNewBattle" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h3 class="modal-title text-danger" id="myModalLabel">New Battle</h3>
            </div>

            <div class="modal-body form-impmon">
                <small><i>Grid/range system is work in progress</i></small>

                <h4>Grid Size</h4>

                <div class="form-group label-floating col-xs-6">
                    <label class="control-label" for="grid-w">Width</label>
                    <input class="form-control" type="number" id="grid-w" min="4" value="12" required/>
                </div>

                <div class="form-group label-floating col-xs-6">
                    <label class="control-label" for="grid-h">Height</label>
                    <input class="form-control" type="number" id="grid-h" min="4" value="7" required/>
                </div>
            </div>

            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-success" id="btn-newbattle" onclick="startBattle()">Start</button>
            </div>
        </div>
    </div>
</div>
