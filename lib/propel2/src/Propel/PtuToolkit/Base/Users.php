...
use Propel\PtuToolkit\Sessions as ChildSessions;
...
abstract class Users implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\PtuToolkit\\Map\\UsersTableMap';
    ...
    /**
     * Initializes internal state of Propel\PtuToolkit\Base\Users object.
     */
     ...
     * @return $this|\Propel\PtuToolkit\Users The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\PtuToolkit\\Users'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->campaignssScheduledForDeletion !== null) {
                if (!$this->campaignssScheduledForDeletion->isEmpty()) {
                    \Propel\PtuToolkit\CampaignsQuery::create()
            ...
            if ($this->sessionssScheduledForDeletion !== null) {
                if (!$this->sessionssScheduledForDeletion->isEmpty()) {
                    \Propel\PtuToolkit\SessionsQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\PtuToolkit\Users
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\PtuToolkit\Users The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\PtuToolkit\Users (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\PtuToolkit\Users Clone of current object.
     * @throws PropelException
     */
    ...
    public function initCampaignss($overrideExisting = true)
    {
        ...
        $this->collCampaignss->setModel('\Propel\PtuToolkit\Campaigns');
    }
    ...
    public function initSessionss($overrideExisting = true)
    {
        ...
        $this->collSessionss->setModel('\Propel\PtuToolkit\Sessions');
    }
