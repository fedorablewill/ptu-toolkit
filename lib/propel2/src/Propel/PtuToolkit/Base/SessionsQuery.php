 ...
 *
 * @method     \Propel\PtuToolkit\UsersQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class SessionsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\PtuToolkit\Base\SessionsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Propel\\PtuToolkit\\Sessions', $modelAlias = null)
    {
