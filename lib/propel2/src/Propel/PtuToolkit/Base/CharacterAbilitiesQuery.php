...
abstract class CharacterAbilitiesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\PtuToolkit\Base\CharacterAbilitiesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Propel\\PtuToolkit\\CharacterAbilities', $modelAlias = null)
    {
