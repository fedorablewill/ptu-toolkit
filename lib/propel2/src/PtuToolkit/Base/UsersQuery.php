 ...
 *
 * @method     \PtuToolkit\CampaignsQuery|\PtuToolkit\SessionsQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class UsersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \PtuToolkit\Base\UsersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\PtuToolkit\\Users', $modelAlias = null)
    {
     ...
     *
     * @param \PtuToolkit\Campaigns|ObjectCollection $campaigns the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    /**
     * Filter the query by a related \PtuToolkit\Sessions object
     *
     * @param \PtuToolkit\Sessions|ObjectCollection $sessions the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildUsersQuery The current query, for fluid interface
     */
    ...
    {
        if ($sessions instanceof \PtuToolkit\Sessions) {
            return $this
            ...
            throw new PropelException('filterBySessions() only accepts arguments of type \PtuToolkit\Sessions or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \PtuToolkit\SessionsQuery A secondary query class using the current class as primary query
     */
    public function useSessionsQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinSessions($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Sessions', '\PtuToolkit\SessionsQuery');
    }
