...
use PtuToolkit\Map\CharactersTableMap;
 ...
 *
 * @method     \PtuToolkit\CampaignsQuery|\PtuToolkit\BattleEntriesQuery|\PtuToolkit\CharacterAbilitiesQuery|\PtuToolkit\CharacterBuffsQuery|\PtuToolkit\CharacterMovesQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CharactersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \PtuToolkit\Base\CharactersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\PtuToolkit\\Characters', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \PtuToolkit\CharacterAbilities object
     *
     * @param \PtuToolkit\CharacterAbilities|ObjectCollection $characterAbilities the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildCharactersQuery The current query, for fluid interface
     */
    ...
    {
        if ($characterAbilities instanceof \PtuToolkit\CharacterAbilities) {
            return $this
            ...
            throw new PropelException('filterByCharacterAbilities() only accepts arguments of type \PtuToolkit\CharacterAbilities or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \PtuToolkit\CharacterAbilitiesQuery A secondary query class using the current class as primary query
     */
    public function useCharacterAbilitiesQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'CharacterAbilities', '\PtuToolkit\CharacterAbilitiesQuery');
    }
    ...
    /**
     * Filter the query by a related \PtuToolkit\CharacterMoves object
     *
     * @param \PtuToolkit\CharacterMoves|ObjectCollection $characterMoves the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildCharactersQuery The current query, for fluid interface
     */
    ...
    {
        if ($characterMoves instanceof \PtuToolkit\CharacterMoves) {
            return $this
            ...
            throw new PropelException('filterByCharacterMoves() only accepts arguments of type \PtuToolkit\CharacterMoves or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \PtuToolkit\CharacterMovesQuery A secondary query class using the current class as primary query
     */
    public function useCharacterMovesQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'CharacterMoves', '\PtuToolkit\CharacterMovesQuery');
    }
