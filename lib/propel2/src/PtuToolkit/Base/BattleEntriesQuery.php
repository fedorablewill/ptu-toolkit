 ...
 *
 * @method     \PtuToolkit\BattlesQuery|\PtuToolkit\CharactersQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class BattleEntriesQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \PtuToolkit\Base\BattleEntriesQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\PtuToolkit\\BattleEntries', $modelAlias = null)
    {
