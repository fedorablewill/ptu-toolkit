...
abstract class CharacterBuffs implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\PtuToolkit\\Map\\CharacterBuffsTableMap';
    ...
    /**
     * Initializes internal state of PtuToolkit\Base\CharacterBuffs object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\PtuToolkit\CharacterBuffs The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PtuToolkit\\CharacterBuffs'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PtuToolkit\CharacterBuffs
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PtuToolkit\CharacterBuffs The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PtuToolkit\CharacterBuffs (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PtuToolkit\CharacterBuffs Clone of current object.
     * @throws PropelException
     */
