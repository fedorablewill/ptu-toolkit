 ...
 *
 * @method     \PtuToolkit\UsersQuery|\PtuToolkit\BattlesQuery|\PtuToolkit\CharactersQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CampaignsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \PtuToolkit\Base\CampaignsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\PtuToolkit\\Campaigns', $modelAlias = null)
    {
     ...
     *
     * @param \PtuToolkit\Battles|ObjectCollection $battles the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildCampaignsQuery The current query, for fluid interface
     */
     ...
     *
     * @param \PtuToolkit\Characters|ObjectCollection $characters the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildCampaignsQuery The current query, for fluid interface
     */
