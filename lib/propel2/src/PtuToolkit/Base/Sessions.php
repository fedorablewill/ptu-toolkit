...
abstract class Sessions implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\PtuToolkit\\Map\\SessionsTableMap';
    ...
    /**
     * Initializes internal state of PtuToolkit\Base\Sessions object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\PtuToolkit\Sessions The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PtuToolkit\\Sessions'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PtuToolkit\Sessions
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PtuToolkit\Sessions The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PtuToolkit\Sessions (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PtuToolkit\Sessions Clone of current object.
     * @throws PropelException
     */
