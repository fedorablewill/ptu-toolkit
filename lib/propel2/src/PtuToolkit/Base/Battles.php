...
abstract class Battles implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\PtuToolkit\\Map\\BattlesTableMap';
    ...
    /**
     * Initializes internal state of PtuToolkit\Base\Battles object.
     */
     ...
     * @return $this|\PtuToolkit\Battles The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PtuToolkit\\Battles'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PtuToolkit\Battles
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PtuToolkit\Battles The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PtuToolkit\Battles (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PtuToolkit\Battles Clone of current object.
     * @throws PropelException
     */
