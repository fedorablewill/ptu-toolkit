...
abstract class Campaigns implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\PtuToolkit\\Map\\CampaignsTableMap';
    ...
    /**
     * Initializes internal state of PtuToolkit\Base\Campaigns object.
     */
     ...
     * @return $this|\PtuToolkit\Campaigns The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\PtuToolkit\\Campaigns'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->battlessScheduledForDeletion !== null) {
                if (!$this->battlessScheduledForDeletion->isEmpty()) {
                    \PtuToolkit\BattlesQuery::create()
            ...
            if ($this->characterssScheduledForDeletion !== null) {
                if (!$this->characterssScheduledForDeletion->isEmpty()) {
                    \PtuToolkit\CharactersQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PtuToolkit\Campaigns
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\PtuToolkit\Campaigns The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PtuToolkit\Campaigns (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PtuToolkit\Campaigns Clone of current object.
     * @throws PropelException
     */
    ...
    public function initBattless($overrideExisting = true)
    {
        ...
        $this->collBattless->setModel('\PtuToolkit\Battles');
    }
    ...
    public function initCharacterss($overrideExisting = true)
    {
        ...
        $this->collCharacterss->setModel('\PtuToolkit\Characters');
    }
