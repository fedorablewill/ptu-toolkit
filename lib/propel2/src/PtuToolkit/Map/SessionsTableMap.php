...
use PtuToolkit\Sessions;
use PtuToolkit\SessionsQuery;
...
class SessionsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PtuToolkit.Map.SessionsTableMap';
     ...
     */
    const OM_CLASS = '\\PtuToolkit\\Sessions';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PtuToolkit.Sessions';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PtuToolkit\\Sessions');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PtuToolkit\Sessions) { // it's a model object
