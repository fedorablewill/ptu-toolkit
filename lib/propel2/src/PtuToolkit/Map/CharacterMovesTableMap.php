...
use PtuToolkit\CharacterMoves;
use PtuToolkit\CharacterMovesQuery;
...
class CharacterMovesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PtuToolkit.Map.CharacterMovesTableMap';
     ...
     */
    const OM_CLASS = '\\PtuToolkit\\CharacterMoves';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PtuToolkit.CharacterMoves';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PtuToolkit\\CharacterMoves');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PtuToolkit\CharacterMoves) { // it's a model object
