...
use PtuToolkit\BattleEntries;
use PtuToolkit\BattleEntriesQuery;
...
class BattleEntriesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'PtuToolkit.Map.BattleEntriesTableMap';
     ...
     */
    const OM_CLASS = '\\PtuToolkit\\BattleEntries';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PtuToolkit.BattleEntries';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\PtuToolkit\\BattleEntries');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PtuToolkit\BattleEntries) { // it's a model object
